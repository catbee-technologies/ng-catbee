...
describe('LocalStorageService', () => {
  ...
  describe('getBoolean', () => {
    it('should parse "true" as boolean true', () => {
      ...
      const result = service.getBoolean('bool-key', false);
    ...
    it('should parse "false" as boolean false', () => {
      ...
      const result = service.getBoolean('bool-key', true);
  ...
  describe('getNumber', () => {
    it('should parse integer values', () => {
      ...
      const result = service.getNumber('num-key', 0);
    ...
    it('should return default for invalid number string', () => {
      ...
      const result = service.getNumber('num-key', 99);
  ...
  describe('getEnum', () => {
    ...
    it('should return valid enum value', () => {
      ...
      const result = service.getEnum('enum-key', TestEnum.Value2, Object.values(TestEnum));
    ...
    it('should return default for null value', () => {
      ...
      const result = service.getEnum('enum-key', TestEnum.Value3, Object.values(TestEnum));
  ...
  describe('getJson and setJson', () => {
    ...
    it('should return default for invalid JSON', () => {
      ...
      const result = service.getJson('json-key', { default: true });
  ...
  describe('getArray and setArray', () => {
    ...
    it('should return default for non-array JSON', () => {
      ...
      const result = service.getArray('array-key', [99]);
    ...
    it('should handle empty arrays', () => {
      ...
      const result = service.getArray('array-key', [1]);
  ...
  describe('getOrSet', () => {
    it('should return existing value', () => {
      ...
      const result = service.getOrSet('key', 'default');

      expect(result).toBe('existing');
      expect(mockLocalStorage.setItem).not.toHaveBeenCalled();
    });

    it('should set and return default if key does not exist', () => {
      (mockLocalStorage.getItem as jasmine.Spy).and.returnValue(null);
  ...
  describe('length', () => {
    ...
    it('should handle getNumber with invalid number', () => {
      (mockLocalStorage.getItem as jasmine.Spy).and.returnValue('not-a-number');

      const result = service.getNumber('key', 42);

      expect(result).toBe(42);
    });

    it('should handle getBoolean with "1"', () => {
      (mockLocalStorage.getItem as jasmine.Spy).and.returnValue('1');
    ...
    it('should handle getBoolean with "0"', () => {
      (mockLocalStorage.getItem as jasmine.Spy).and.returnValue('0');
    ...
    it('should handle getBoolean with invalid value', () => {
      (mockLocalStorage.getItem as jasmine.Spy).and.returnValue('invalid');
    ...
    it('should handle getArray with empty array default', () => {
      (mockLocalStorage.getItem as jasmine.Spy).and.returnValue(null);
    ...
    it('should handle getEnum with valid string value', () => {
      ...
      const result = service.getEnum<Status>('key', 'inactive', statusValues);
...
describe('SessionStorageService', () => {
  ...
  describe('advanced features', () => {
    ...
    it('should get or set values atomically', () => {
    ...
    it('should return existing value in getOrSet', () => {
    ...
    it('should handle getArray with parse error', () => {
      ...
      const result = service.getArray('key', [1, 2]);
