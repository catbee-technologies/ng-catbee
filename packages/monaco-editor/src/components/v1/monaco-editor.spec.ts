  ...
  describe('CatbeeMonacoEditor', () => {
    ...
    describe('ControlValueAccessor', () => {
      ...
      it('should set disabled state and update editor options', async () => {
        ...
        expect(spy).toHaveBeenCalledWith(jasmine.objectContaining({ readOnly: true }));
      });
    ...
    describe('Signal Integration', () => {
      it('should update editorValue signal on content change', async () => {
        const fixture = create(TestComponent);
        await fixture.whenStable();
        await delay();
        const comp = fixture.componentInstance.comp;
        ...
        await delay(100);
        expect((comp as any).editorValue()).toBe('signal test');
      });
      ...
      it('should react to model changes via effect', async () => {
        ...
        fixture.componentInstance.comp.model.set({ value: 'new', language: 'javascript' });
        await delay(100);
    ...
    describe('Placeholder', () => {
      ...
      it('should hide placeholder when editor has content', async () => {
        ...
        await delay();
        const comp = fixture.componentInstance.comp;
        (comp as any).editorValue.set('hello');
    ...
    describe('Options & Configuration', () => {
      ...
      it('should not reInit when updating with same language', async () => {
        ...
        comp.previousLanguage.set('html');
