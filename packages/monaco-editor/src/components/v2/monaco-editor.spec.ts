...
describe('CatbeeMonacoEditorComponents (V2 - Signal Forms)', () => {
  describe('CatbeeMonacoEditorV2', () => {
    ...
    describe('FormValueControl Interface', () => {
      ...
      it('should expose errors input signal', async () => {
        const fixture = create(TestEditorComponent);
        await fixture.whenStable();
        await delay();
        const comp = fixture.componentInstance.comp;
      ...
      it('should expose invalid input signal', async () => {
        const fixture = create(TestEditorComponent);
        await fixture.whenStable();
        await delay();
        const comp = fixture.componentInstance.comp;
      ...
      it('should expose valid input signal', async () => {
        const fixture = create(TestEditorComponent);
        await fixture.whenStable();
        await delay();
        const comp = fixture.componentInstance.comp;
      ...
      it('should expose readonly input signal', async () => {
        const fixture = create(TestEditorComponent);
        await fixture.whenStable();
        await delay();
        const comp = fixture.componentInstance.comp;
      ...
      it('should expose required input signal', async () => {
        const fixture = create(TestEditorComponent);
        await fixture.whenStable();
        await delay();
        const comp = fixture.componentInstance.comp;
      ...
      it('should expose name input signal', async () => {
        const fixture = create(TestEditorComponent);
        await fixture.whenStable();
        await delay();
        const comp = fixture.componentInstance.comp;
      ...
      it('should expose pending input signal', async () => {
        const fixture = create(TestEditorComponent);
        await fixture.whenStable();
        await delay();
        const comp = fixture.componentInstance.comp;
    ...
    describe('Signal Reactivity', () => {
      it('should react to model changes via effect', async () => {
        const fixture = create(TestEditorComponent);
        await fixture.whenStable();
        await delay();
        const spy = spyOn(fixture.componentInstance.comp, 'updateOptions');
        fixture.componentInstance.model.set({ language: 'javascript' });
        fixture.detectChanges();
        await delay(100);
    ...
    describe('Options & Configuration', () => {
      ...
      it('should reInit editor when language changes', async () => {
        ...
        fixture.componentInstance.options.set({ language: 'json' });
        await delay();
        expect(spy).toHaveBeenCalled();
      });
    ...
    describe('Monaco Model', () => {
      it('should create model with uri when provided', async () => {
        ...
        fixture.componentInstance.model.set({
          value: 'test',
          language: 'typescript',
          uri: monaco.Uri.parse('file:///test.ts')
        });
        await fixture.whenStable();
        await delay();
        const editor = fixture.componentInstance.comp.editor;
      ...
      it('should reuse existing model when available', async () => {
        const uri = monaco.Uri.parse('file:///v2-existing.js');
        let existingModel = monaco.editor.getModel(uri);
        if (!existingModel) {
          existingModel = monaco.editor.createModel('existing', 'javascript', uri);
        }
        const fixture = create(TestEditorComponent);
        fixture.componentInstance.model.set({ uri, language: 'javascript' });
        await fixture.whenStable();
        await delay();
        expect(fixture.componentInstance.comp.editor?.getModel()).toBe(existingModel);
      });
    });
  });
...
class TestEditorComponent {
  ...
  model = signal<CatbeeMonacoEditorModel>({ language: 'typescript' });
