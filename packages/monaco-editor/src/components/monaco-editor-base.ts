  ...
  implements AfterViewInit, OnDestroy
{
  ...
  /**
   * Whether to recreate the editor instance when options change. - default is `false`.
   ...
   */
  readonly recreateOnOptionsChange = input(false, { transform: booleanAttribute });
  ...
  updateOptions(v: MonacoEditorOptions | undefined): void {
    ...
    if (this.recreateOnOptionsChange()) {
      this.reInitMonaco(v);
    } else {
