...
<div style="display: flex; flex-wrap: wrap; gap: 0.5rem; margin: 1rem 0;">
  ...
  <img src="https://codecov.io/gh/catbee-technologies/ng-catbee/graph/badge.svg?token=XAJHK6R1OQ" alt="Coverage" />
  <img src="https://img.shields.io/node/v/@ng-catbee/monaco-editor" alt="Node Version" />
...
Currently this library only supports load monaco-editor with AMD mode. The default is to use cdn (https://cdn.jsdelivr.net/npm/monaco-editor) lazy loading.
