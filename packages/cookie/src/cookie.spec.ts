...
describe('provideCatbeeCookie', () => {
  it('should provide CATBEE_COOKIE_CONFIG with empty object when no config provided', () => {
    TestBed.configureTestingModule({
      providers: [provideCatbeeCookie()]
    });

    const config = TestBed.inject(CATBEE_COOKIE_CONFIG);
    expect(config).toEqual({});
  });

  it('should provide CATBEE_COOKIE_CONFIG with provided config', () => {
    const customConfig: CookieOptions = {
      path: '/app',
      expires: 30,
      secure: true,
      sameSite: 'Strict'
    ...
    TestBed.configureTestingModule({
      providers: [provideCatbeeCookie(customConfig)]
    });
  ...
  it('should provide CATBEE_COOKIE_CONFIG with partial config', () => {
    const partialConfig: CookieOptions = {
      secure: true
    };

    TestBed.configureTestingModule({
      providers: [provideCatbeeCookie(partialConfig)]
    });
